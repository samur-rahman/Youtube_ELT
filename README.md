...
4. The first (initial) API pull loads the data - this is the initial full upload. Successive pulls upserts the values for certain variables (columns). Once the core schema is populated and both unit and data quality tests have been implemented, the data is then ready for analysis.
...
- Variables are specified as such: `AIRFLOW_VAR_{VARIABLE_NAME}`
